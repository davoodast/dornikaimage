...
export default function HomeClient({ initialSettings }: { initialSettings: PublicSettings }) {
  const [publicSettings, setPublicSettings] = useState<PublicSettings>(initialSettings);
  ...
  // No client-side settings fetch needed — initialSettings arrived as a server prop.
  // Settings can still be refreshed by child components if needed in future.
